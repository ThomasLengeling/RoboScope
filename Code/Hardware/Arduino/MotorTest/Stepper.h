...
class Stepper {
  public:
    ...
    //constructor
    Stepper(int id, int steps, int dir_pin, int step_pin, int sleep_pin, int m0_pin, int m1_pin) {
      MOTOR_STEPS = steps
                    DIR_PIN   = dir_pin;
      STEP_PIN  = step_pin;
      sleep_pin = SLEEP_PIN;
      ...
      //init motor driver
      motor = new DRV8880(MOTOR_STEPS, DIR_PIN, STEP_PIN, SLEEP_PIN, M0_PIN, M1_PIN);
